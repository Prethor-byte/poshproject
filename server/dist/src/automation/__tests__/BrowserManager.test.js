...
jest.mock('../utils/errors', () => ({
    AutomationError: jest.fn().mockImplementation((message, type) => {
...
describe('BrowserManager', () => {
    ...
    beforeEach(() => {
        ...
        manager = BrowserManager_1.BrowserManager.getInstance();
    });
    afterEach(async () => {
    ...
    it('should handle session creation failure', async () => {
        ...
        await expect(manager.createSession(mockProfile, testUserId)).rejects.toThrow(errors_1.AutomationError);
    });
    ...
    describe('createSession', () => {
        ...
        it('should set up request interception', async () => {
            ...
            const routeCallback = mockContext.route.mock.calls[0][1];
